...
def log(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        args_list = list(
            [str(arg) if not isinstance(arg, numbers.Number) else arg for arg in args[1:]] + list(kwargs.values())
        )
        ...
        # Convert to tuple for a consistent display
        ...
        # Shorten the output if too long
